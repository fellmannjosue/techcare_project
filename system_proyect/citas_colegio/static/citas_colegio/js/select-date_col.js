// static/citas_colegio/js/select-date_col.js
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadTimeSlots(date) {
        ...
        fetch(`/citas_colegio/get-available-slots_col/?teacher_id=${teacherId}&date=${date}`)
            ...
            if (response.ok) {
                Swal.fire({
                    ...
                    html: `<p><strong>Fecha:</strong> ${date}</p>
                           <p><strong>Hora:</strong> ${time}<br>
                           Esperar la confirmación del encargado<br>GRACIAS POR ESPERAR</p>`,
                    icon: 'success',
                    confirmButtonText: 'Aceptar',
                }).then(() => {
